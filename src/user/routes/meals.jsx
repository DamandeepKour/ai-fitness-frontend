        ...
        <Card className="glass-card rounded-3xl p-0 border-0 overflow-hidden">
          <div className="flex flex-wrap items-start justify-between gap-4 border-b-4 border-foreground px-4 py-2">
            <div>
              ...
              <h2 className="text-xl font-black leading-none mt-1">
                Nutrition Facts{" "}
                <span className="text-sm font-normal text-muted-foreground">
                  (Today compared with previous day)
                </span>
              </h2>
            </div>
            <div className="rounded-2xl bg-foreground px-2 py-2 text-background flex items-center justify-between">
            {/* <span className="text-xs opacity-80">Energy today</span> */}

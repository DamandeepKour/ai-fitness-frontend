...
const Signup = () => {
  ...
  const validators = useMemo(
    () => ({
      ...
      phone: (v) => validatePhone(v, { required: false }),
        ...
        <div className="relative p-6 md:p-8 bg-gradient-to-br from-card via-card to-emerald-500/5">
          ...
          <div className="relative">
            ...
            <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
              Sign up with your email — free, no payment required.
            </p>
            ...
            <div className="space-y-3">
              ...
              <OutlinedField
                ...
                onBlur={async () => {
                  touch("email");
                  if (!validateField("email", form.email, form)) {
                    await verifyEmailOnServer(form.email);
                  }
                }}
              />
              {emailVerifying ? (
              ...
              {!emailVerifying && emailVerified && !emailFieldError ? (
                <p className="text-xs text-emerald-600 -mt-1">Email looks good</p>
              ) : null}
            ...
            >
              {loading ? "Creating account…" : emailVerifying ? "Checking email…" : "Create account"}
            </button>
